  ...
  render() {
    ...
    return (
      <div className="movie-card">
        ...
        {/* <CardFront poster={this.props.movieInfo.poster}/>
        <CardBack title={this.props.movieInfo.title} genre={this.props.movieInfo.genres} IMDBRating={this.props.movieInfo.IMDBRating}   /> */}
